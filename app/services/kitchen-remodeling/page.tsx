      ...
      <section className="py-16 bg-black border-t border-zinc-800/50">
        <div className="container-wide max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/blog/kitchen-cabinet-options" className="card-luxury p-6 group">
              <h3 className="font-serif text-lg text-white mb-2">Cabinet Guide</h3>
              <p className="text-zinc-400 text-sm mb-3">Stock, semi-custom, or custom? Compare your options.</p>
              <span className="text-primary text-sm uppercase tracking-wide inline-flex items-center gap-2 group-hover:gap-3 transition-all">
                Read Guide <ArrowRight className="h-4 w-4" />
              </span>
            </Link>
            <Link href="/reviews" className="card-luxury p-6 group">
              ...
              <p className="text-zinc-400 text-sm mb-3">See what homeowners say about our kitchen work.</p>
              <span className="text-primary text-sm uppercase tracking-wide inline-flex items-center gap-2 group-hover:gap-3 transition-all">
