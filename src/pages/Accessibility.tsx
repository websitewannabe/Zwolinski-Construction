    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="prose max-w-none">
        <section className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4 text-zwolinski-navy">
          ...
          <p className="mb-4">
            ...
            on granting equal service to people with disabilities who use
            information displayed on the website, and on improving their
            browsing experience. We seek to ensure that our digital services
            will be accessible to people with disabilities, and accordingly, we
            have invested in the website's ease of use for people with
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            let us know if you encounter any accessibility barriers by
            contacting us at support@websitewannabe.com.
          </p>
        </section>
      </div>
    </div>
