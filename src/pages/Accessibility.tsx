...
const Accessibility = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      <Helmet>
        <title>Accessibility | Zwolinski Quality Construction</title>
        <meta
          name="description"
          content="Learn how Zwolinski Quality Construction ensures digital accessibility and ADA compliance for all visitors on our website."
        />
        <meta
          name="keywords"
          content="accessibility statement, ADA compliance, WCAG standards, accessible website, Zwolinski Construction accessibility, inclusive design"
        />
        <link
          rel="canonical"
        ...
        <script type="application/ld+json">{`
          {
            ...
            "description": "This page outlines our commitment to digital accessibility, including ADA compliance and WCAG standards for all users of the Zwolinski Quality Construction website.",
            "publisher": {
              "@type": "Organization",
