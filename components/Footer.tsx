        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <a
                href="https://www.google.com/maps/place/Zwolinski+Quality+Construction/@40.3507719,-75.276024,871m/data=!3m2!1e3!4b1!4m6!3m5!1s0x89c6a05cc01b6e05:0x4f72758643065789!8m2!3d40.3507719!4d-75.276024!16s%2Fg%2F11clvrzxh5?entry=ttu"
                className="w-9 h-9 flex items-center justify-center rounded border border-zinc-800 text-zinc-400 hover:text-white hover:border-transparent hover-gradient transition-all"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Find us on Google Business Profile"
              >
                <Image src="/GBP_Icon.png" alt="Google Business Profile" width={20} height={20} className="h-5 w-5" />
              </a>
            </div>
            <button
